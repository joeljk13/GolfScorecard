...
<head>
    ...
    <link rel="stylesheet" href="js/jquery/jquery-ui-1.11.1/jquery-ui.min.css">
    <link rel="stylesheet" href="css/scorecard.css">
    <script src="js/jquery/jquery-2.1.1.min.js"></script>
    <script src="js/jquery/jquery-ui-1.11.1/jquery-ui.min.js"></script>
...
?>
            <td class="scorecard"><input type="text" class="scorecard" maxlength="8" id="<?php echo $hid; ?>name" placeholder="" size="2"
                title="Click to set the par"/></td>
<?php
    }
} /* Hole - Front 9 */
?>
...
?>
            <td class="number"><input type="text" class="number" maxlength="8" id="<?php echo $hid; ?>name" placeholder="" size="2"
                title="Click to enter the hole <?php echo $h; ?> score for player <?php echo $i; ?>"/></td>
<?php
    }
} /* Hole - Front 9 */
?>
...
?>
    ...
    <span class="scorecard_id">
        ...
        <input class="scorecard_id" type="text" id="scorecard_id" name="scorecard_id" value="" size="40" placeholder="???" readonly="readonly"/>
...
<ul>
    <li><a href="http://www.dgcoursereview.com/">DGCourseReview.com</a> &ndash; Has lots of information on disc golf courses everywhere.</li>
    <li><a href="http://www.inboundsdiscgolf.com/">Inbounds Disc Golf</a> &ndash; Has a comparison of the various types of discs.</li>
</ul></p>
...
<div id="score_entry_dialog" title="Score Entry">
    ...
    <table class="score_entry">
        <tr>
            ...
            <td class="score_entry_cmd" colspan="3"><button type="button" class="score_entry_cmd" id="valueDone" name="valueDone"
        ...
        <tr>
            ...
            <td class="score_entry_cmd" colspan="3"><button type="button" class="score_entry_cmd" id="valueCancel" name="valueCancel"
        ...
        <tr>
            ...
            <td class="score_entry_cmd" colspan="3"><button type="button" class="score_entry_cmd" id="valueBackspace" name="valueBackspace"
        ...
        <tr>
            ...
            <td class="score_entry_cmd" colspan="3"><button type="button" class="score_entry_cmd" id="valueClear" name="valueClear"
        ...
        <tr>
            ...
            <td></td>
            <td><button type="button" class="score_entry" id="valuestar" name="valuestar" onclick="javascript:scoreEntryAppend('*');">*</button></td>
            <td><button type="button" class="score_entry" id="valuehash" name="valuehash" onclick="javascript:scoreEntryAppend('#');">#</button></td>
            <td><button type="button" class="score_entry" id="valueplus" name="valueplus" onclick="javascript:scoreEntryAppend('+');">+</button></td>
        </tr>
        <tr id="score_instructions_row" name="score_instructions_row">
            <td class="score_entry_instructions" colspan="6" id="score_instructions" name="score_instructions">
                The *, #, and + symbols can be used to keep track of special cases, such as mulligans, gimmes, clangs, or a minimum approximate score.
            </td>
        </tr>
    </table>
    </form>
